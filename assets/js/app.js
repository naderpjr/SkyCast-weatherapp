// <a href="https://github.com/naderpjr">naderpjr</a>
 ...
 * @param {string} evenType Event type of for example "click", "mouseover"
                ...
                for (const { name, lat, lon, country, state } of locations) {
                    ...
                    searchItem.innerHTML = `
                            ...
                            <div>
                                ...
                                <p class="label-2 iteem-subtitle">${state || ""} ${country}</p>
                            </div>
            ...
            for (const [index, data] of forecastList.entries()) {
                ...
                windLi.innerHTML = `
                    <div class="card card-sm slider-card">
                        ...
                        <p class="body-3">
                            ${parseInt(module.mps_to_kmh(windSpeed))} km/h&deg;
                        </p>
                    </div>
